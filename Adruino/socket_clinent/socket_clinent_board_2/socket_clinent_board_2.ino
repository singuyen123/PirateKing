...
void setup()
{
    ...
    if (client.connected()) {
        ...
        client.send("device-connection","{\"device\":\"device2\"}");
...
void loop()
{
      ...
      while(Serial.available()){
        ...
        if(InChar == '.') 
        {
          ...
          if(InString[0]=='d' )
           {
               client.send("move", "{\"id\":\"2\",\"action\":\"Right\"}");
               InString="";
           }
        
          if(InString[0]=='a' )
          {
             client.send("move", "{\"id\":\"2\",\"action\":\"Left\"}");
             InString="";
          ...
          if(InString[0]=='w' )
          {
             client.send("move", "{\"id\":\"2\",\"action\":\"Down\"}");
             InString="";
             
          }
          if(InString[0]=='x' )
          {
             client.send("move", "{\"id\":\"2\",\"action\":\"Up\"}");
             InString="";
             
          }
          if(InString[0]=='s' )
          {
             client.send("move", "{\"id\":\"2\",\"action\":\"Hit\"}");
             InString="";
             
          }
          if(InString[0]=='q' )
          {
             client.send("move", "{\"id\":\"2\",\"action\":\"Drop_horizontal\"}");
             InString="";
             
          }
          if(InString[0]=='z' )
          {
             client.send("move", "{\"id\":\"2\",\"action\":\"Drop_vertical\"}");
             InString="";
